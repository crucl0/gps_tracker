...
#     except InvalidId:
#         return HTTPNotFound("There is no such object")
# # END of the Point REST
# # =====================


# #============================
# # START of the Companies REST


# # @view_config(route_name='companies', request_method='GET', renderer='json')
# # def companies_get_all(request):
# #     return list(request.mongo_db.companies.find())
